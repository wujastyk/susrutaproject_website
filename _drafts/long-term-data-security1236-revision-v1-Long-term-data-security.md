...
date: '2022-06-21T07:23:41-06:00'
author: 'Dominik Wujastyk'
layout: revision
guid: 'https://sushrutaproject.org/?p=1353'
permalink: '/?p=1353'
---
...
This adds one more layer of long-term security to the data of the Suśruta Project. It is our hope that future generations of scholars will continue to find innovative ways to discover new knowledge from this project.<span class="footnote_referrer"><a onclick="footnote_moveToReference_1353_871('footnote_plugin_reference_1353_871_1');" onkeypress="footnote_moveToReference_1353_871('footnote_plugin_reference_1353_871_1');" role="button" tabindex="0"><sup class="footnote_plugin_tooltip_text" id="footnote_plugin_tooltip_1353_871_1">\[1\]</sup></a><span class="footnote_tooltip" id="footnote_plugin_tooltip_text_1353_871_1">I am grateful to Dr Michael Willis for conversations that encouraged me to explore Zenodo.</span></span><script type="text/javascript"> jQuery('#footnote_plugin_tooltip_1353_871_1').tooltip({ tip: '#footnote_plugin_tooltip_text_1353_871_1', tipClass: 'footnote_tooltip', effect: 'fade', predelay: 0, fadeInSpeed: 200, delay: 400, fadeOutSpeed: 200, position: 'top center', relative: true, offset: [-7, 0], });</script>

<div class="speaker-mute footnotes_reference_container"><div class="footnote_container_prepare"><span class="footnote_reference_container_label pointer" onclick="footnote_expand_collapse_reference_container_1353_871();" role="button" tabindex="0">Footnotes</span><span class="footnote_reference_container_collapse_button" onclick="footnote_expand_collapse_reference_container_1353_871();" role="button" style="display: none;" tabindex="0">\[<a id="footnote_reference_container_collapse_button_1353_871">+</a>\]</span>

</div><div id="footnote_references_container_1353_871" style="">Footnotes
| <a class="footnote_backlink" id="footnote_plugin_reference_1353_871_1"><span class="footnote_index_arrow">↑</span>1</a> | I am grateful to Dr Michael Willis for conversations that encouraged me to explore Zenodo. |
|---|---|

 </div></div><script type="text/javascript"> function footnote_expand_reference_container_1353_871() { jQuery('#footnote_references_container_1353_871').show(); jQuery('#footnote_reference_container_collapse_button_1353_871').text('−'); } function footnote_collapse_reference_container_1353_871() { jQuery('#footnote_references_container_1353_871').hide(); jQuery('#footnote_reference_container_collapse_button_1353_871').text('+'); } function footnote_expand_collapse_reference_container_1353_871() { if (jQuery('#footnote_references_container_1353_871').is(':hidden')) { footnote_expand_reference_container_1353_871(); } else { footnote_collapse_reference_container_1353_871(); } } function footnote_moveToReference_1353_871(p_str_TargetID) { footnote_expand_reference_container_1353_871(); var l_obj_Target = jQuery('#' + p_str_TargetID); if (l_obj_Target.length) { jQuery( 'html, body' ).delay( 0 ); jQuery('html, body').animate({ scrollTop: l_obj_Target.offset().top - window.innerHeight * 0.2 }, 380); } } function footnote_moveToAnchor_1353_871(p_str_TargetID) { footnote_expand_reference_container_1353_871(); var l_obj_Target = jQuery('#' + p_str_TargetID); if (l_obj_Target.length) { jQuery( 'html, body' ).delay( 0 ); jQuery('html, body').animate({ scrollTop: l_obj_Target.offset().top - window.innerHeight * 0.2 }, 380); } }</script>